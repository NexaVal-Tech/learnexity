...
Route::post('/password/email', [AuthController::class, 'sendResetLink'])->middleware('throttle:3,1');
...
// =================== ADMIN ROUTES =================== //
Route::middleware(['jwt.auth', 'role:admin'])->prefix('admin/courses/{courseId}/resources')->group(function () {
