...
export const AccessBlockedBanner: React.FC<AccessBlockedBannerProps> = ({ enrollment, onPayNow }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#0f0f14] rounded-2xl max-w-2xl w-full p-8 shadow-2xl">
        <div className="text-center">
          ...
          {/* Payment Details */}
          <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-6 mb-6 text-left">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{enrollment.course_name}</span>
              </div>

              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-300">Installment:</span>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="px-6 py-4 border-2 border-gray-300 dark:border-white/10 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
            >
              Go to Dashboard
            </button>
          </div>
