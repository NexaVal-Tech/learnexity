  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="register now to start your learning journey Immediately."
        />
      ...
      <AppLayout>
        <style>{`
          ...
          /* Hide the original checkboxes on mobile, show mobile copy instead */
          .checkboxes-left-col {
            display: none;
          }
          ...
          @media (min-width: 1024px) {
            .checkboxes-left-col {
              display: contents; /* renders children inline, no extra box */
            }
            .checkboxes-right-col {
              display: none;
            }
            ...
            <form onSubmit={handleSubmit}>
              <div className="two-col-form">
                ...
                <div className="left-col">
                  ...
                  <div className="checkboxes-left-col">
                    ...
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      <span className="text-sm text-gray-500">
                        <a href="/terms-of-services" target="_blank" rel="noopener noreferrer" className="page-switch-link">
                          I agree to the Terms & Conditions
                        </a>
                        {" "}and{" "}
                        <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="page-switch-link">
                          Privacy Policy
                        </a>
                      </span>
                    </label>
                ...
                <div className="right-col">
                  ...
                  {/* Mobile only — hidden on desktop via CSS, sits right after Confirm Password */}
                  <div className="checkboxes-right-col">
                    ...
                    <label className="flex items-start gap-2 pt-4 md:pt-10 cursor-pointer">
                      <input
                        type="checkbox"
                        name="acceptedTerms"
                        checked={formData.acceptedTerms}
