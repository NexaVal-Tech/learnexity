...
export default function AuthCallback() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-[#08080c] dark:to-[#0f0f14]">
      <div className="text-center p-8 bg-white dark:bg-[#0f0f14] rounded-lg shadow-lg dark:shadow-black/40 max-w-md">
        <div className="relative mb-6">
          <div className="animate-spin rounded-full h-16 w-16 border-4 border-blue-200 dark:border-blue-500/20 border-t-blue-600 mx-auto" />
        ...
        <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Signing You In</h2>
