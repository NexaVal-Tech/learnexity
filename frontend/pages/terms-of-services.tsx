            ...
            {isTocOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="h-px bg-gray-300 dark:bg-white/10 mb-4"></div>
            ...
            <div className="max-w-[1500px] mx-auto px-4 sm:px-6 py-22 sm:py-12 lg:py-30">
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    ...
                    <div className="hidden lg:block w-64 flex-shrink-0">
                        <div className="sticky top-24 p-6 border-2 dark:border-white/10 rounded-2xl">
                    ...
                    <div className="flex-1 prose prose-blue dark:prose-invert max-w-none border-2 dark:border-white/10 rounded-2xl px-4 sm:px-6 py-6">
                        <div className="mb-8">
                            <div className="flex items-center gap-2 mb-4">
                                <svg className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600 bg-gray-200 dark:bg-white/10 rounded-full p-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Last updated: November 30, 2024</p>
                        </div>

                        <div className="h-px bg-gray-300 dark:bg-white/10 mb-6"></div>
                        ...
                        <section id="acceptance" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">2. Acceptance and Changes</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">2.1 Acceptance</h3>
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">2.2 Changes</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="eligibility" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Eligibility</h2>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="accounts" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">4. Accounts, Registration & Security</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">4.1 Account Creation</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">4.2 Security</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="services" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">5. Services, Courses & Subscriptions</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">5.1 Course Access</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">5.2 Availability</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">5.3 Community</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="payments" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">6. Payments, Billing & Refunds</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">6.1 Payments</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">6.2 Subscriptions</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">6.3 Refunds</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="intellectual" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">7. Intellectual Property</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">7.1 Our Rights</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">7.2 Limited License</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                        ...
                        <section id="user-content" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">8. User Conduct & Moderation</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">8.1 Prohibited Conduct</h3>
                            <ul className="list-disc pl-5 sm:pl-6 space-y-1 text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2 mt-4">8.2 Moderation</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                                We may moderate, remove, or refuse content that violates these Terms or community guidelines.
                            </p>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">8.3 Reviews and Testimonials</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="third-party" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">9. Third-Party Sales & Services</h2>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="disclaimers" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">10. Disclaimers & No Guarantees</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">10.1 Educational Nature</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">10.2 As-Is Services</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="termination" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">13. Termination</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">13.1 By You</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                                You may close your account at any time by contacting us or by using the Services.
                            </p>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">13.2 By Us</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="governing" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">14. Governing Law & Dispute Resolution</h2>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <section id="changes" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">15. Changes to the Services</h2>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">15.1 Contact</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                            ...
                            <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-4 space-y-3">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                    <div className="flex items-center gap-2 flex-shrink-0">
                                        ...
                                        <span className="text-xs sm:text-sm text-gray-700 dark:text-gray-300">Phone: </span>
                                    </div>
                        ...
                        <section id="miscellaneous" className="mb-8 scroll-mt-4">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">16. Miscellaneous</h2>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">16.1 Entire Agreement</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                                These Terms and any referenced policies constitute the entire agreement between you and Learnings regarding the Services.
                            </p>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">16.2 Severability</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                                If any condition is unenforceable, the remaining provisions remain in effect.
                            </p>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2">16.3 Assignment</h3>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                                Learnings may assign its rights or obligations without your consent; you may not assign without our written consent.
                            </p>
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed italic mt-8">
