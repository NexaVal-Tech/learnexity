...
const QUESTIONS = [
  ...
  },
  {
    ...
    hint: 'Be honest — this helps us understand your financial situation better.',
    type: 'select' as const,
    options: [
      { value: 'unemployed', label: 'Unemployed', sub: 'Currently not working' },
      { value: 'student', label: 'Student', sub: 'Full-time or part-time student' },
      { value: 'employed_under_100k', label: 'Employed', sub: 'Earning less than ₦100,000/month' },
      { value: 'employed_100k_200k', label: 'Employed', sub: 'Earning ₦100,000 – ₦200,000/month' },
      { value: 'employed_above_200k', label: 'Employed', sub: 'Earning above ₦200,000/month' },
    ],
  },
  {
    id: 'outcome_plan',
