...
class SendDailyCheckinEmailsJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($userIds as $userId) {
            ...
            // Get the user's best login streak across all courses
            ...
            try {
                ...
                Log::info('✅ [DailyCheckin] Email queued', [
                    'user_id' => $userId,
                    'courses' => count($courseData),
                ]);
            } catch (\Exception $e) {
        ...
        Log::info("✅ [DailyCheckin] Done. Sent: {$sent}, Skipped (already sent today): {$skipped}");
    }
}