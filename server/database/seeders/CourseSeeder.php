        ...
        DB::transaction(function () use ($coursesData) {
            foreach ($coursesData as $courseData) {
                ...
                if (isset($courseData['tools'])) {
                    foreach ($courseData['tools'] as $index => $tool) {
                        $course->tools()->create([
                            'name' => $tool['name'],
                            'icon' => $tool['icon'] ?? null,
                            'order' => $index,
                ...
                // Seed learnings
                if (isset($courseData['whatYouWillLearn'])) {
                    foreach ($courseData['whatYouWillLearn'] as $index => $learning) {
                ...
                // Seed benefits
                if (isset($courseData['keyBenefits'])) {
                    foreach ($courseData['keyBenefits'] as $index => $benefit) {
                ...
                // Seed career paths
                if (isset($courseData['careerPath'])) {
                    $order = 0;
                    foreach ($courseData['careerPath'] as $level => $positions) {
                        foreach ($positions as $position) {
                            $course->careerPaths()->create([
                                'level' => $level,
                                'position' => $position,
                                'order' => $order++,
                            ]);
                ...
                // Seed industries
                if (isset($courseData['industries'])) {
                    foreach ($courseData['industries'] as $index => $industry) {
                        $course->industries()->create([
                ...
                // Seed salary
                if (isset($courseData['salary'])) {
                    $course->salary()->create([
                        'entry_level' => $courseData['salary']['entry'] ?? null,
                        'mid_level' => $courseData['salary']['mid'] ?? null,
                        'senior_level' => $courseData['salary']['senior'] ?? null,
                    ]);
                }
            }
        });
    ...
    private function getCoursesData(): array
    {
        return [
            [
                ...
                'description' => 'Master AI tools and no-code automation. Build AI-powered solutions from prompt engineering to workflow automation using cutting-edge generative AI platforms.',
            ...
            [
                ...
                'description' => 'Master cloud infrastructure and services across major platforms. Learn to design, deploy, and manage scalable cloud solutions following AWS, Microsoft Azure, and Google Cloud best practices.',
            ...
            [
                ...
                'description' => 'Build cybersecurity skills from zero experience to job-ready proficiency. Aligned with ISC2 Certified in Cybersecurity (CC) standards and includes practical vulnerability assessment and incident response training.',
            ...
            [
                ...
                'description' => 'Master DevOps practices and tools for continuous integration, deployment, and infrastructure management. Learn to bridge development and operations following industry best practices.',
            ...
            [
                ...
                'description' => 'Master blockchain fundamentals and build decentralized applications from scratch. Learn Solidity programming, smart contracts, and Web3 integration following ConsenSys and Ethereum Foundation standards.',
            ...
            [
                ...
                'description' => 'Design user-centered digital experiences. Master design principles, user research, and create responsive interfaces with industry-standard tools and accessibility guidelines.',
            ...
            [
                ...
                'description' => 'Lead product development from ideation to launch. Master user research, roadmapping, and cross-functional team management following Product School and Pragmatic Institute frameworks.',
            ...
            [
                ...
                'description' => 'Master digital marketing from SEO to paid advertising. Build complete marketing campaigns and measure success with analytics following Google Digital Garage and HubSpot Academy standards.',
            ...
            [
                ...
                'description' => 'Transform raw data into actionable insights. Master data analysis, visualization, and predictive modeling with Python and Power BI following Microsoft and Google certification standards.',
            ...
            [
                ...
                'description' => 'Master professional video editing from storytelling to final export. Create engaging content for social media, commercials, and documentaries following Adobe Certified Professional standards.',
            ...
            [
                ...
                'description' => 'Build modern, responsive web applications with JavaScript and React. Master frontend development from basic programming to full-stack integration following Google, Microsoft, and Meta standards.',
            ...
            [
                ...
                'description' => 'Master server-side development with PHP and Laravel. Build secure, scalable backend systems and REST APIs following PSR standards and OWASP security practices.',
            ...
            [
                ...
                'description' => 'Develop essential workplace skills for career success. Master communication, leadership, and emotional intelligence following the World Economic Forum 21st Century Skills framework.',
